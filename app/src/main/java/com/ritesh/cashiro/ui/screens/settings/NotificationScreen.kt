...
import com.ritesh.cashiro.ui.viewmodel.NotificationViewModel
...
fun NotificationScreen(
    ...
    val scanEnabled by viewModel.scanNewTransactionsEnabled.collectAsStateWithLifecycle()
    val alertTimeMinutes by viewModel.scanNewTransactionsAlertTime.collectAsStateWithLifecycle()
            ...
            confirmButton = {
                TextButton(
                    onClick = {
                        ...
                        viewModel.setScanNewTransactionsAlertTime(newMinutes)
            ...
            Column(
                ...
                Column(
                    ...
                    PreferenceSwitch(
                        ...
                        checked = scanEnabled,
                        onCheckedChange = viewModel::setScanNewTransactionsEnabled,
                        leadingIcon = {
                            Box(
                                modifier = Modifier
                                    .size(48.dp)
                ...
                Column(
                    ...
                    PreferenceSwitch(
                        ...
                        onCheckedChange = viewModel::setUpcomingNotificationsEnabled,
                        leadingIcon = {
                            Box(
                                modifier = Modifier
                                    .size(48.dp)
                                ...
                                ListItem(
                                    ...
                                    trailing = {
                                        Switch(
                                            ...
                                            onCheckedChange = { 
                                                viewModel.toggleSubscriptionNotification(item.subscription.id, it)
                                            }
                                        )
                                    },
                                    onClick = { 
                                        viewModel.toggleSubscriptionNotification(item.subscription.id, !item.isNotificationEnabled)
                                    },
